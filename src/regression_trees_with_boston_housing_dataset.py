...
tree_metrics.to_excel(
    f"{base_path}/test/tree_metrics_boston_housing.xlsx",
    index=False,
)
print(
    f"Metrics saved to {base_path}/test/tree_metrics_boston_housing.xlsx")
print(
...
graph = Source(dot_data)
graph.render(
    f"{base_path}/img/boston_housing_best_tree_depth_{best_depth}",
    format='png',
)
